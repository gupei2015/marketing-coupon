...
import lk.project.marketing.backend.mapper.CouponSummaryManagementMapper;
...
@Repository
@Slf4j
public class CouponSummaryManagementRepository extends ServiceImpl<CouponSummaryManagementMapper, CouponSummary> {

    @Autowired
    CouponSummaryManagementMapper couponSummaryManagementMapper;
    ...
    public List<CouponHistoryInfoBo> getCouponHistoryDetails(String userId, String orderId){
        return couponSummaryManagementMapper.getCouponHistoryDetailsByUserOrder(userId, orderId);
    }
