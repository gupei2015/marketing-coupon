...
import lk.project.marketing.backend.mapper.CouponConsumeManagementMapper;
 ...
 */
@Repository
public class CouponConsumeManagementRepository extends ServiceImpl<CouponConsumeManagementMapper, CouponConsume> {
