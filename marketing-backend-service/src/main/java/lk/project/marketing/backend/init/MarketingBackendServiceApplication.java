package lk.project.marketing.backend.init;
...
@Slf4j
public class MarketingBackendServiceApplication {
    public static void main(String... args) {
        SpringApplication.run(MarketingBackendServiceApplication.class, args);
